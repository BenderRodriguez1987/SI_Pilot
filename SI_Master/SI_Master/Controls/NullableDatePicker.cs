...
namespace SI_Master.Controls
{
    public class NullableDatePicker : DatePicker
    {
        ...
        public static readonly BindableProperty PlaceHolderProperty =
            BindableProperty.Create(nameof(PlaceHolder), typeof(string), typeof(NullableDatePicker), "Не выбрано");
        ...
        private void UpdateDate()
        {
            ...
            {
                Format = _originalFormat == null ? "d" : _originalFormat;
            }
            else
            {
                Format = PlaceHolder;
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            if (propertyName == DateProperty.PropertyName || (propertyName == IsFocusedProperty.PropertyName && !IsFocused &&
