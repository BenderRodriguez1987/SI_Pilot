...
namespace SI_Master.Managers.ArchiveCardBlockManager
{
    public class ArchiveCardBlockManager: IArchiveCardBlockManager
    {
        ...
        public async Task<List<Block>> GetArchiveCardLimits(Dictionary<string, object> _filterParams)
        {
            ...
            try
            {
                ...
                answer = await networkservice.NetworkRequest(NetworkService.TaskType.ARchiveCardBlock, authmanager.GetAuthData(), _tmpFilter);
